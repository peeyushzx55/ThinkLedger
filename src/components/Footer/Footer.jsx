...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden py-12 backdrop-blur-md bg-white/5 border-t border-white/20">
            ...
            <div className="flex flex-col h-full">
              <div className="mb-6">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  Share your thoughts, ideas, and stories with the world. A
                  modern platform for bloggers and content creators.
                </p>
              </div>
              <div className="mt-auto">
                <p className="text-sm text-gray-400">
                  © {new Date().getFullYear()} ThinkLedger. All rights reserved.
                </p>
              </div>
            </div>
          </div>
